...
NOTE BY MARCUS: The magic of Python is that other people have probably
ran into and solved the exact same problem as you have, 10x better...
CREDIT: https://github.com/biolab/orange/blob/master/Orange/OrangeCanvas/gui/dropshadow.py
"""
...
# NOTE BY MARCUS: THIS ONE IS UNUSED
class DropShadowFrame(QWidget):
    ...
    color_ = pyqtProperty(QColor, fget=color, fset=setColor, designable=True,
    ...
    radius_ = pyqtProperty(int, fget=radius, fset=setRadius, designable=True,
...
# NOTE BY MARCUS: THIS ONE IS USED
